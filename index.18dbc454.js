...
parcelHelpers.export(exports, "getFirebaseApp", ()=>getFirebaseApp);
var _navigo = require("navigo");
var _navigoDefault = parcelHelpers.interopDefault(_navigo);
var _header = require("./components/header/header");
var _pageContainer = require("./components/pageContainer/pageContainer");
var _footer = require("./components/footer/footer");
const $wrapper = document.getElementById("wrapper");
let root = null;
let useHash = true;
let hash = "#!";
let router = new (0, _navigoDefault.default)(root, useHash, hash);
const header = (0, _header.getHeader)();
const pageContainer = (0, _pageContainer.getPageContainer)();
const footer = (0, _footer.getFooter)();
router.on({
    "/": async ()=>{
        pageContainer.innerHTML = "";
        const moduleMain = await require("c9050cc09d86f60c");
        const mainPage = moduleMain.getHome();
        pageContainer.append(mainPage);
        header.setActiveLink("home");
    },
    "/admin": async ()=>{
        pageContainer.innerHTML = "";
        const moduleAdmin = await require("f0762d5e270e9d3e");
        const adminPage = moduleAdmin.getAdminPage();
        pageContainer.append(adminPage);
    },
    "/portfolio": async ()=>{
        pageContainer.innerHTML = "";
        const modulePortfolio = await require("63ed96ea20fe909c");
        const portfolioPage = modulePortfolio.getPortfolio();
        pageContainer.append(portfolioPage);
        header.setActiveLink("portfolio");
    },
    "/portfolio/:title": async (event)=>{
        console.log(event);
        pageContainer.innerHTML = "";
        const moduleProduct = await require("508f0005bce73044");
        const productPage = moduleProduct.getItemPage(event);
...
$wrapper.append(header.header, pageContainer, footer);

},{"navigo":"fuSlc","./components/header/header":"k3piG","./components/pageContainer/pageContainer":"ht0nH","c9050cc09d86f60c":"3pPk5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/footer/footer":"gOx3S","f0762d5e270e9d3e":"6Td5w","63ed96ea20fe909c":"hk6Tu","508f0005bce73044":"gtclA"}],"fuSlc":[function(require,module,exports) {
!function(t, n) {
    module.exports = n();
...
function getHeader() {
    const header = (0, _element.getElement)("header", "header");
    const container = (0, _element.getElement)("div", "container", "header__container");
    const headerLogo = (0, _element.getElement)("div", "header__logo");
    const logoText = (0, _element.getElement)("h3", "header__logo--text");
    logoText.innerHTML = "Evgeniy <br> Fabritskiy";
    const nav = (0, _element.getElement)("nav", "header__nav", "nav");
    const navList = (0, _element.getElement)("ul", "nav__list", "list-reset");
    const links = {
        "home": (0, _navLink.getNavLink)("/", "\u0413\u043B\u0430\u0432\u043D\u0430\u044F"),
        "portfolio": (0, _navLink.getNavLink)("/portfolio", "\u041F\u043E\u0440\u0442\u0444\u043E\u043B\u0438\u043E"),
        "reviews": (0, _navLink.getNavLink)("/reviews", "\u041E\u0442\u0437\u044B\u0432\u044B \u0438 \u043F\u0440\u0430\u0439\u0441")
    };
    for(const oneLink in links){
        const navLi = (0, _element.getElement)("li", "nav__item");
    ...
    headerLogo.append(logoText);
    container.append(headerLogo, navList);
...
},{"../element/element":"b7qoT","../navLink/navLink":"iN4hD","./header.css":"39x7f","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b7qoT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getElement", ()=>getElement);
function getElement(elementType, ...classes) {
...
},{}],"iN4hD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getNavLink(path = "", text = "") {
    const link = (0, _element.getElement)("a", "nav__link");
    link.href = path;
...
},{"../../main":"1SICI","../element/element":"b7qoT","./navLink.css":"1Y1fF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Y1fF":[function() {},{}],"39x7f":[function() {},{}],"ht0nH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPageContainer", ()=>getPageContainer);
var _element = require("../element/element");
function getPageContainer() {
    const pageContainer = (0, _element.getElement)("main", "main");
    return pageContainer;
}

},{"../element/element":"b7qoT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3pPk5":[function(require,module,exports) {
module.exports = Promise.all([
    require("a0a3877b25b4a6b7")(require("1102223e2b0d0904").getBundleURL("10Mjw") + "home.53a207eb.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("3388b4e4e2d32cdf")(require("1102223e2b0d0904").getBundleURL("10Mjw") + "home.d216b3bd.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("75PfU"));

},{"a0a3877b25b4a6b7":"1MWPE","1102223e2b0d0904":"lgJ39","3388b4e4e2d32cdf":"61B45"}],"1MWPE":[function(require,module,exports) {
"use strict";
...
},{"ca2a84f7fa4a3bb0":"j49pS"}],"gOx3S":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getFooter() {
    const footer = (0, _element.getElement)("footer", "footer");
    const container = (0, _element.getElement)("div", "container", "footer__container");
    const policy = (0, _element.getElement)("div", "footer__policy");
    policy.textContent = "\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430 \u043A\u043E\u043D\u0444\u0435\u0434\u0438\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438";
    const phone = (0, _element.getElement)("a", "footer__phone");
    phone.textContent = "+7 777 777 77 77";
    container.append(policy, phone);
    footer.append(container);
    return footer;
}

},{"../element/element":"b7qoT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./footer.css":"gkVeN"}],"gkVeN":[function() {},{}],"6Td5w":[function(require,module,exports) {
module.exports = Promise.all([
    require("8686bf4d35c57daa")(require("94ac560609da89de").getBundleURL("10Mjw") + "admin.0aa37b9c.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("e635253dddcf4436")(require("94ac560609da89de").getBundleURL("10Mjw") + "admin.f168d97c.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("8686bf4d35c57daa")(require("94ac560609da89de").getBundleURL("10Mjw") + "admin.b3ac6623.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("htvUa"));

},{"8686bf4d35c57daa":"61B45","94ac560609da89de":"lgJ39","e635253dddcf4436":"1MWPE"}],"hk6Tu":[function(require,module,exports) {
module.exports = Promise.all([
    require("2a2b3e639c645573")(require("4ccfa29daf663c21").getBundleURL("10Mjw") + "portfolio.e16049b1.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("90735b252c84d95a")(require("4ccfa29daf663c21").getBundleURL("10Mjw") + "admin.0aa37b9c.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
    require("90735b252c84d95a")(require("4ccfa29daf663c21").getBundleURL("10Mjw") + "portfolio.ffcb268e.js" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    })
]).then(()=>module.bundle.root("5xEC2"));

},{"2a2b3e639c645573":"1MWPE","4ccfa29daf663c21":"lgJ39","90735b252c84d95a":"61B45"}],"gtclA":[function(require,module,exports) {
module.exports = require("5ebb52bbd2801a3e")(require("ead7ad9c20f636d3").getBundleURL("10Mjw") + "itemPage.ded28fed.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("6XyXJ"));

},{"5ebb52bbd2801a3e":"61B45","ead7ad9c20f636d3":"lgJ39"}]},["j2YDk","1SICI"], "1SICI", "parcelRequired04d")
