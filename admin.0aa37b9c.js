...
})({"9GfRP":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9a9dd9eb0aa37b9c";
"use strict";
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"SJ4UY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9iWsB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPhotosList", ()=>getPhotosList);
var _element = require("../element/element");
var _database = require("firebase/database");
var _app = require("firebase/app");
var _photosListCss = require("./photosList.css");
function getPhotosList() {
    const photosDiv = (0, _element.getElement)("div", "portfolio__photos");
    const categroyList = (0, _element.getElement)("div", "list-reset", "portfolio__categories");
    const list = (0, _element.getElement)("ul", "list-reset", "portfolio__list");
    ...
    function getPortfolioFromDB() {
        ...
        (0, _database.get)((0, _database.child)(dbref, "portfolio/")).then((snapshot)=>{
            ...
            createCategoriesItems(portfolioArray);
            createPortfolio(portfolioArray);
        });
    }
    function createPortfolio(portfolioArray) {
        console.log(portfolioArray);
        list.innerHTML = "";
        portfolioArray.forEach((oneItem)=>{
            const portfolioLi = (0, _element.getElement)("li", "portfolio__item");
            const portfolioLink = (0, _element.getElement)("a", "portfolio__item--link");
            portfolioLink.href = `/portfolio/${oneItem.nameEng}`;
            portfolioLi.dataset.id = oneItem.id;
            const coverImage = (0, _element.getElement)("img", "portfolio__item--img");
            coverImage.src = oneItem.linkOfCover;
            const coverName = (0, _element.getElement)("h4", "portfolio__item--name");
            coverName.textContent = oneItem.nameRu;
            portfolioLi.append(coverImage, coverName, portfolioLink);
            list.append(portfolioLi);
        });
    }
    const allItem = (0, _element.getElement)("li", "portfolio__tag");
    allItem.addEventListener("click", ()=>{
        const tags = document.querySelectorAll(".portfolio__tag");
        tags.forEach((oneTag)=>{
    ...
    function createCategoriesItems(array) {
        const items = [];
        array.forEach((onePost)=>{
            items.push(onePost.category);
        });
        console.log(items);
        categroyList.innerHTML = "";
        allItem.classList.add("active");
        allItem.textContent = "\u0412\u0441\u0435";
        allItem.dataset.value = "\u0412\u0441\u0435";
        categroyList.append(allItem);
        const uniqueItems = Array.from(new Set(items));
        uniqueItems.forEach((item)=>{
            if (!categroyList.querySelector(`[data-value="${item}"]`)) {
                const oneItem = (0, _element.getElement)("li", "portfolio__tag");
                oneItem.textContent = item;
                oneItem.dataset.value = item;
                oneItem.addEventListener("click", ()=>{
                    ...
                    let filteredPortfolio = portfolio.filter((element)=>element.category.toLowerCase().trim() === oneItem.dataset.value.toLowerCase().trim());
                    createPortfolio(filteredPortfolio);
                });
                categroyList.append(oneItem);
            }
        });
    }
    getPortfolioFromDB();
    photosDiv.append(categroyList, list);
    return photosDiv;
}

},{"../element/element":"b7qoT","firebase/database":"SJ4UY","firebase/app":"aM3Fo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./photosList.css":"4Y1Jp"}],"4Y1Jp":[function() {},{}]},["9GfRP"], null, "parcelRequired04d")

//# sourceMappingURL=admin.0aa37b9c.js.map
